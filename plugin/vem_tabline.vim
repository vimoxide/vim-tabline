...
map <silent> <Plug>vem_prev_buffer- :call vem_tabline#tabline.select_buffer('left')<CR>

" select next buffer
map <silent> <Plug>vem_next_buffer- :call vem_tabline#tabline.select_buffer('right')<CR>

" move buffer to the left
map <silent> <Plug>vem_move_buffer_left- :call vem_tabline#tabline.move_buffer('left')<CR>

" move buffer to the right
map <silent> <Plug>vem_move_buffer_right- :call vem_tabline#tabline.move_buffer('right')<CR>

" delete buffer
map <silent> <Plug>vem_delete_buffer- :call vem_tabline#tabline.delete_buffer()<CR>
...
augroup VemTabLine
    ...
    autocmd VimResized * call vem_tabline#tabline.refresh()
